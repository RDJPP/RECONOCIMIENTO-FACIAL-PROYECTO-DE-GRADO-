...
def registrar_usuario():
    ...
    Label(ventana8, text="").pack()
    Label(ventana8, text="").pack()
    Label(ventana8, text="Registro de usuario exitoso", font=("Calibri", 11)).pack()
    Label(ventana8, text="").pack()
    Label(ventana8, text="").pack()
    Button(ventana8, text="Ok", width=15, height=1, command=registro_usuario).pack()
...
def registro_facial():
    ...
    Label(ventana10, text="").pack()
    Label(ventana10, text="").pack()
    Label(ventana10, text="Registro facial usuario exitoso", font=("Calibri", 11)).pack()
    Label(ventana10, text="").pack()
    Label(ventana10, text="").pack()
    Button(ventana10, text="Ok", width=15, height=1, command=cerrar_facial_2).pack()
...
def registro_facial_2():
    ...
    usuario_entrada.delete(0, END)  # Limpiamos los text variables
    # Label(pantalla3, text = "Registro Facial Exitoso", fg = "green", font = ("Calibri",11)).pack()
    global ventana9
    ventana9 = Toplevel()
    ventana9.geometry("300x200")
    ventana9.title("Registro usuario")
    Label(ventana9, text="").pack()
    Label(ventana9, text="").pack()
    Label(ventana9, text="").pack()
    Label(ventana9, text="Registro facial de cliente exitosos", font=("Calibri", 11)).pack()
    Label(ventana9, text="").pack()
    Label(ventana9, text="").pack()
    Button(ventana9, text="Ok", width=15, height=1, command=cerrar_facial).pack()
...
def registrar_cliente():
    usuario_info = usuario.get()  # Obetnemos la informacion almacenada en usuario
    cedula_info = cedula.get()  # Obtenemos la informacion almacenada en contra
    telefono_info = telefono.get()

    archivo = open(usuario_info, "w")  # Abriremos la informacion en modo escritura
    archivo.write(usuario_info + "\n")  # escribimos la info
    archivo.write(cedula_info + "\n")
    archivo.write(telefono_info + "\n")
    archivo.close()

    # Limpiaremos los text variable
    usuario_entrada.delete(0, END)
    cedula_entrada.delete(0, END)
    telefono_entrada.delete(0, END)

    # Ahora le diremos al usuario que su registro ha sido exitoso
    # Label(pantalla3, text = "Registro Cliente Exitoso", fg = "green", font = ("Calibri",11)).pack()
    global ventana7
    ventana7 = Toplevel()
    ventana7.geometry("300x200")
    ventana7.title("Registro clientes")
    Label(ventana7, text="").pack()
    Label(ventana7, text="").pack()
    Label(ventana7, text="").pack()
    Label(ventana7, text="Registro de Cliente Exitoso", font=("Calibri", 11)).pack()
    Label(ventana7, text="").pack()
    Label(ventana7, text="").pack()
    Button(ventana7, text="Ok", width=15, height=1, command=registro_cliente_tradicional).pack()
...
def verificacion_login():
    ...
    if log_usuario in lista_archivos:  # Comparamos los archivos con el que nos interesa
        ...
        if log_contra in verificacion:
            ...
            Label(ventana3, text="").pack()
            Label(
                ventana3, text="Contraseña incorrecta, ingrese de nuevo", font=("Calibri", 11)
            ).pack()
            Label(ventana3, text="").pack()
            Label(ventana3, text="").pack()
            Button(ventana3, text="Ok", width=15, height=1, command=contra_incorrecta).pack()
    else:
        ...
        Label(ventana4, text="").pack()
        Label(
            ventana4, text="Usuario no encontrado, favor registrarse", font=("Calibri", 11)
        ).pack()
        Label(ventana4, text="").pack()
        Label(ventana4, text="").pack()
        Button(ventana4, text="Ok", width=15, height=1, command=usuario_no_encontrado).pack()


# ---------------------------PRUEBA DE MENSAJE EMERGENTE-----------------------------------------
...
def registro_clientes():
    ...
    global usuario_entrada
    global cedula
    global cedula_entrada
    global telefono
    global telefono_entrada
    global pantalla3
    pantalla3 = Toplevel()  # Esta pantalla es de un nivel superior a la principal
    pantalla3.title("Registro de Clientes")
    pantalla3.geometry("400x600")  # Asignamos el tamaño de la ventana
    pantalla2.withdraw()
    ventana1.withdraw()
    ...
    Label(pantalla3, text="").pack()
    Label(
        pantalla3, text="Registro facial: debe de asignar un usuario:", font=("Century Gothic", 12)
    ).pack()
    Label(
        pantalla3,
        text="Registro tradicional: debe asignar usuario y contraseña:",
    ...
    Label(
        pantalla3, text="Usuario * ", font=("Century Gothic", 12)
    ).pack()  # Mostramos en la pantalla 1 el usuario
    usuario_entrada = Entry(
        pantalla3, textvariable=usuario
    )  # Creamos un text variable para que el usuario ingrese la info
    usuario_entrada.pack()
    Label(
        pantalla3, text="Cedula * ", font=("Century Gothic", 12)
    ).pack()  # Mostramos en la pantalla 1 la contraseña
    cedula_entrada = Entry(
        pantalla3, textvariable=cedula
    )  # Creamos un text variable para que el usuario ingrese la contra
    cedula_entrada.pack()
    Label(
        pantalla3, text="Telefono * ", font=("Century Gothic", 12)
    ).pack()  # Mostramos en la pantalla 1 la contraseña
    telefono_entrada = Entry(
        pantalla3, textvariable=telefono
    )  # Creamos un text variable para que el usuario ingrese la contra
    telefono_entrada.pack()
    Label(pantalla3, text="").pack()  # Dejamos un espacio para la creacion del boton
    Button(
        pantalla3,
...
def login_facial():
    ...
    if usuario_login + ".jpg" in im_archivos:  # Comparamos los archivos con el que nos interesa
        ...
        if similitud >= 0.80:
            ...
            Label(ventana5, text="").pack()
            Label(
                ventana5, text="Rostro incorrecto, verifique su usuario", font=("Calibri", 11)
            ).pack()
            Label(ventana5, text="").pack()
            Label(ventana5, text="").pack()
            Button(ventana5, text="Ok", width=15, height=1, command=rostro_incorrecto).pack()
    else:
        print("Usuario no encontrado")
        # Label(pantalla2, text = "Usuario no encontrado", fg = "red", font = ("Calibri",11)).pack()
        global ventana6
        ...
        Label(ventana6, text="").pack()
        Label(
            ventana6, text="Usuario no encontrado, favor registrarse", font=("Calibri", 11)
        ).pack()
        Label(ventana6, text="").pack()
        Label(ventana6, text="").pack()
        Button(ventana6, text="Ok", width=15, height=1, command=rostro_no_encontrado).pack()
...
def registro_cliente_tradicional():
    ventana7.destroy()
...
def start_app1():
    ...
    ventana999.call(
        ...
        "iconphoto",
        ventana999._w,
        PhotoImage(file=os.path.join(os.path.dirname(__file__), "logo.png")),
    )
    app999 = Ventana2(ventana999)
    app999.mainloop()
